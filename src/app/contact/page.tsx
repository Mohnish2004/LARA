    ...
    <div className="mt-12 gap-6 lg:gap-16">
      ...
      <div className="divide-y divide-gray-200 dark:divide-neutral-800">
        ...
        <div className="flex gap-x-7 py-6">
          <svg className="shrink-0 size-6 mt-1.5  dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
          <div className="grow">
            ...
            <a className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium hover:text-gray-800 focus:outline-none focus:text-gray-800  dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="#">
              Contact support
